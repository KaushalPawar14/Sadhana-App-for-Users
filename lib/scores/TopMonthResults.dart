...
class MonthlyLeaderboardPage extends StatefulWidget {
  ...
  @override
  State<MonthlyLeaderboardPage> createState() =>
      _MonthlyLeaderboardPageState();
}

class _MonthlyLeaderboardPageState extends State<MonthlyLeaderboardPage> with TickerProviderStateMixin {
  ...
  Future<List<Map<String, dynamic>>> fetchTop3() async {
    final metaSnap = await firestore
        ...
        .doc('monthly_meta')
        .get();
    final monthId = metaSnap.data()?['last_month_finalized'];
    ...
    final data = monthSnap.data()?['topUsers'];
    if (data == null) return [];
        ...
        return Scaffold(
          ...
          body: FutureBuilder<List<Map<String, dynamic>>>(
            ...
            builder: (context, snapshot) {
              ...
              /// ✅ show badge if current user is in top 3
              /// ✅ show badge if current user is in top 3
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                "Results will be announced on next month",
                                textAlign: TextAlign.center,
                                style: TextStyle(
                                  fontSize: 26,
                                  fontWeight: FontWeight.bold,
                ...
                if (!_badgeShown) {
                  ...
                  WidgetsBinding.instance.addPostFrameCallback((_) async {
                    ...
                    if (users.length > 0 && users[0]['name'] == currentName) {
                      await showBadgeDialog(context, "gold_badge");
                    }
                    else if (users.length > 1 && users[1]['name'] == currentName) {
                      await showBadgeDialog(context, "silver_badge");
                    }
                    else if (users.length > 2 && users[2]['name'] == currentName) {
                      await showBadgeDialog(context, "bronze_badge");
                    }
                  ...
                  Positioned(
                    ...
                    child: Center(
                      child: Builder(builder: (context) {
                        ...
                        String message;
                        if (rankIndex == 0) {
                          message = "🏆 Congratulations! You are 1st this month!";
                        } else if (rankIndex == 1) {
                          message = "🥈 Great job! You are 2nd this month!";
                        } else if (rankIndex == 2) {
                          message = "🥉 Well done! You are 3rd this month!";
                        } else {
